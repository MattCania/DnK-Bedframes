...
<div class="relative">
	...
	<Sidebar
		...
		class="sidebar-zinc z-40 h-screen w-64 border-0 bg-zinc-700 p-0"
	>
		<img src="/logo.png" alt="" class="m-10 mx-auto h-[172px] w-[172px] rounded-lg bg-white p-4" />
		<SidebarGroup class="bg-zinc-700">
			...
			<SidebarDropdownWrapper label="Account" btnClass="p-2 text-white hover:bg-zinc-600">
				...
				<SidebarItem
					onclick={() => signOut()}
					label="Sign Out"
					class="cursor-pointer text-white hover:bg-zinc-600"
				/>
			</SidebarDropdownWrapper>
		</SidebarGroup>
	</Sidebar>
